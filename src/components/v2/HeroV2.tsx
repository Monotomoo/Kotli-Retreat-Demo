...
// poetic serif line, coordinates rail. Luxury "trip ticket" card right.
const INK = '#0d120c';
const IVORY = '#f6f3ec';
const BRASS = '#b08d57';
...
export default function HeroV2() {
  ...
  return (
    ...
    >
      ...
      />
      {/* Warm brass glow behind the title */}
      <div
      ...
      />
      {/* Warm light wash over the footage */}
      <div
      ...
      {/* Coordinates rail — left margin annotation */}
      <motion.div
      ...
      <div className="relative z-10 w-full px-5 md:px-[6vw] pt-28 md:pt-0 pb-14 md:pb-20 flex flex-col md:flex-row md:items-end justify-between gap-8 md:gap-14">
        ...
        <div className="max-w-[680px]">
          ...
          {/* Poetic line — the soul sentence */}
          <motion.p
            className="font-serif italic text-[17px] md:text-[19px] leading-relaxed mb-9 max-w-[480px]"
          ...
          >
            ...
            <span
              onClick={() => document.getElementById('includes')?.scrollIntoView({ behavior: 'smooth' })}
        ...
        {/* Right — luxury trip ticket */}
        <motion.div
          className="w-full md:w-[372px] shrink-0"
            ...
            <div className="px-5 md:px-6 py-1 md:py-2">
              {hooks.map((hook, i) => (
                <motion.div
                  ...
                  transition={{ duration: 0.45, delay: 1.15 + i * 0.09, ease: 'easeOut' }}
                >
